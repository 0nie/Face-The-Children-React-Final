      ...
      <section className="general-donation pt-[140px]">
        <div className="container px-2 max-w-[410px] mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1100px] xl:max-w-[990px]">
          ...
          <div className="general-wrapper flex flex-col lg:flex-row lg:gap-5 pb-[80px]   ">
                ...
                <img 
                    src="public/images/donate/feeding.jpg" 
                    alt="General Giving" 
            ...
            <div className="description">
                <h2 className='pt-[30px] pb-[20px] mb-[16px] text-[25px] text-[#3A3B36] leading-4 border-b border-gray-100'>Feeding Program</h2>
                <p className='text-[14px] text-light text-[#3A3B36] mb-[40px]'>Weekly Community Development Programs (CDP) in impoverished communities. These gatherings consist of providing a meal for the children, story-telling, games, assistance with homework, and gift-giving when possible.
