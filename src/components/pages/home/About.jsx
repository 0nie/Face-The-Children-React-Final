    ...
    <div>
      <section className="about py-24">
        <div className="container px-2 max-w-[410px] mx-auto sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1100px] xl:max-w-[1300px]">
          <div className="about-wrapper flex flex-col items-center gap-10 lg:flex-row lg:justify-between lg:items-center">
            ...
            <div className="description w-full lg:w-[500px] xl:w-[507px]">
              ...
              {/* Stats */}
              <div className="counts-wrapper grid grid-cols-2 gap-x-6 gap-y-4 md:gap-2">
                {data.map((items, key) => (
                  <div className="card p-[8px]" key={key}>
                    <h3 className="text-[#fb9f30] text-[25px] lg:text-[32px] xl:text-[40px] font-semibold leading-8">
                      {items.number}<span className='font-semibold text-[24px]'>+</span>
                    </h3>
