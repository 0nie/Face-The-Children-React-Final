         ...
         <div className="container  px-2  mx-auto  max-w-[410px] p-4 lg:max-w-[1300px] lg:mx-auto">
            <div className="affiliates-wrap text-center">
                ...
                <div className="associates mt-[16px] flex flex-col items-center gap-4 justify-around flex-wrap lg:flex-row ">
                    <img src="/src/components/images/logo-fwc.png" alt="" className='w-[202px] h-[45px] ' />
                    <img src="/src/components/images/logo-fbs.png" alt="" className='w-[202px] h-[53px] '/>
                    <img src="/src/components/images/logo-fca.png" alt="" className='w-[202px] h-[78px] '/>
                    <img src="/src/components/images/logo-ftw.png" alt="" className='w-[202px] h-[79px] ' />
                    <img src="/src/components/images/logo-pfm.png" alt="" className='w-[170] h-[54px] ' />
