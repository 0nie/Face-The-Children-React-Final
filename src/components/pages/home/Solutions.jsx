  ...
  return (
    <div>
      <section className="solutions pb-24 lg:pb-15">
        <div className="container  px-2 max-w-[410px] mx-auto pb-4 pt-20 sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1100px] xl:max-w-[1300px] lg:pt-[180px] xl:pt-[205px]">
            <div className="solutions-wrapper flex items-center flex-col gap-10 lg:flex-row-reverse lg:justify-between lg:items-center lg:gap-[200px]">
                <img src="/images/home/h-service.png" alt="solutions-image" className='w-[398px] h-[398px] sm:w-[360px] sm:h-[340px] lg:w-[480px] lg:h-[450px] xl:w-[504px] xl:h-[504px]' />
