  ...
  return (
    <div>
      ...
      <div className="container max-w-[410px] px-[8px] py-14 lg:py-[40px] lg:px-[0] mx-auto m-0 lg:max-w-[1100px] lg:mx-auto ">
        ...
        <div className="contact-wrapper grid gap-[10px] h-[400px] lg:h-[650px]  items-start place-content-center
        lg:grid-cols-2 lg:gap-[40px]">

            <div className="top">
                <Headings label="FREQUENTLY ASKED QUESTIONS"/>
                <Header label="Can't find what you are looking for? "/>
                <p className='text-[14px] text-balance text-[#3a3b36] leading-7 mt-[16px] mb-[40px]'>If your questions is not listed above, you can use the form to send directly to us your questions</p>
            </div>
            ...
            <div className="form-wrapper">
                ...
                <form action="">
                    ...
                    <div className="input flex flex-col mb-6  relative">
                        ...
                        <input type="text" required className='border border-gray-300 rounded-lg p-[8px] bg-gray-100 h-[35px] outline-none focus:border-[#3e9bd0]' />
                    </div>

                    <div className="input flex flex-col mb-6 relative">
                        <label htmlFor="" className='text-[12px] px-[4px] text-[#3e9bd0] absolute top-[-9px] left-[8px] bg-gray-100'>Email</label>
                        <input type='email' required className='border border-gray-300 rounded-lg p-[8px] h-[35px] bg-gray-100 outline-none focus:border-[#3e9bd0]' />
                    </div>

                    <div className="input flex flex-col mb-6 relative">
                        <label htmlFor="" className='text-[12px] px-[4px] text-[#3e9bd0] absolute top-[-9px] left-[8px] bg-gray-100'>Phone</label>
                        <input type="tel" required className='border border-gray-300 rounded-lg p-[8px] h-[35px] bg-gray-100 outline-none focus:border-[#3e9bd0]' />
                    </div>

                    <div className="input flex flex-col mb-6 relative">
                        <label htmlFor="" className='text-[12px] px-[4px] text-[#3e9bd0] absolute top-[-9px] left-[8px] bg-gray-100'>Subject</label>
                        <input type="text" required className='border border-gray-300 rounded-lg p-[8px] h-[35px] bg-gray-100 outline-none focus:border-[#3e9bd0]' />
                    </div>
                    ...
                    <div className="input flex flex-col relative">
                        ...
                        <textarea name="" id="" required className='border border-gray-300 rounded-lg p-[8px] resize-none bg-gray-100 h-[250px] outline-none focus:border-[#3e9bd0]'></textarea>
                    </div>
                    ...
                    <div className="box w-[300px] h-[80px] border border-gray-300 py-3 px-3 flex items-center justify-between rounded-sm mt-[16px]">
                        ...
                        <div className="captcha flex flex-col items-center">
                            <img src="/src/components/images/recapcha logo.png" className='w-[32px] h-[32px]' alt="" />
