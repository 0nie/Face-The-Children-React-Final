            ...
            <div className="selection px-[16px] bg-white pt-[25px]">
              <form className="flex flex-col gap-[22px]">
                ...
                <div className="remarks relative">
                  ...
                  <textarea className="border border-gray-300 p-2 rounded-md w-full h-[112px] resize-none text-[12px] text-[#3A3B36]" required />
                </div>
              ...
              <div className="mode-of-payment flex justify-end pb-[20px]">
                <div className="cards">
                  ...
                  <img src="/public/images/modal/cards.png" alt="" />
                </div>
              </div>
            </div>
          </motion.div>
